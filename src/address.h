 ...
 * brief: 网络地址封装
 */
#ifndef __GUDE_ADDRESS_H
#define __GUDE_ADDRESS_H
...
public:
     ...
     * param: address 域名, IP, 服务器名等.举例: www.gude.com
     *        port 端口号
     ...
     *        host 域名,服务器名等. 举例: www.gude.com[:80] (方括号为可选内容)
     ...
     * param: host 域名, 服务器名等. 举例: www.gude.com[:80] (方括号为可选内容)
     *        family 协议族(AF_INET, AF_INET6, AF_UNSPEC ...)
     *        type socket类型(SOCK_STREAM、SOCK_DGRAM ...)
     *        protocol 协议(IPPROTO_TCP、IPPROTO_UDP ...)
